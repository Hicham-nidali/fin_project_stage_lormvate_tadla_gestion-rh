...
<div class="container-fluid">
    <h1 class="mt-2 mb-4">Mon Pointage de présence</h1>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="text-center mb-4">
                        ...
                        <p class="text-muted">Chef de Département - {{ $user->department->name ?? 'N/A' }}</p>
                    </div>
                            ...
                            <div class="card h-100">
                                <div class="card-body text-center">
                                    ...
                                    @if(!$todayAttendance || !$todayAttendance->check_in)
                                        <form action="{{ route('department-head.attendance.check-in') }}" method="POST">
                                            @csrf
                            ...
                            <div class="card h-100">
                                <div class="card-body text-center">
                                    ...
                                    @if($todayAttendance && $todayAttendance->check_in && !$todayAttendance->check_out)
                                        <form action="{{ route('department-head.attendance.check-out') }}" method="POST">
                                            @csrf
                    ...
                    <div class="d-grid mt-4">
                        <a href="{{ route('department-head.attendance.history') }}" class="btn btn-outline-primary">
