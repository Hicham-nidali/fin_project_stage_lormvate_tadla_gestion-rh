...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ route('employee.announcements.index') }}" class="btn btn-secondary">
    ...
    <div class="row">
        ...
        <div class="col-lg-4">
            ...
            <div class="card mt-3">
                ...
                <div class="card-body">
                    <div class="d-grid gap-2">
                        <a href="{{ route('employee.announcements.index') }}" class="btn btn-outline-primary btn-sm">
                            <i class="fas fa-list me-1"></i>Toutes les Annonces
                        </a>
                        <a href="{{ route('employee.announcements.index', ['read_status' => 'unread']) }}" class="btn btn-outline-warning btn-sm">
                            <i class="fas fa-envelope me-1"></i>Annonces Non Lues
                        </a>
                        <a href="{{ route('employee.announcements.index', ['priority' => 'urgent']) }}" class="btn btn-outline-danger btn-sm">
...
function setReminder(minutes = null) {
    if (minutes) {
        alert(`Rappel défini pour ${minutes} minutes avant la réunion. Cette fonctionnalité nécessite l'intégration avec un système de notifications.`);
    } else {
...
function reportIssue() {
    const issue = prompt('Décrivez le problème concernant cette annonce :');
    if (issue) {
        alert('Merci pour votre signalement. Il sera transmis à l\'administration.');
        // Ici vous pourriez envoyer le signalement à un endpoint
    }
}
